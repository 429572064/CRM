# Generated by Django 2.1.1 on 2018-11-15 20:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campuses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employee.Campuses', verbose_name='校区')),
                ('teachers', models.ManyToManyField(db_constraint=False, to=settings.AUTH_USER_MODEL, verbose_name='老师')),
            ],
        ),
        migrations.CreateModel(
            name='ConsultRecord',
            fields=[
                ...
                ('consultant', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='records', to=settings.AUTH_USER_MODEL, verbose_name='跟进人')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('class_list', models.ManyToManyField(blank=True, to='employee.ClassList', verbose_name='已报班级')),
                ('consultant', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customers', to=settings.AUTH_USER_MODEL, verbose_name='销售')),
                ('introduce_from', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='employee.Customer', verbose_name='转介绍自学员')),
            ],
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employee.Customer', verbose_name='所咨询客户'),
        ),
